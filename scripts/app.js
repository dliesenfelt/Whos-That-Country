...
function newQuestion() {
    ...
    console.log('new answer loaded: ' + randomQuestion.name);
...
function getRandomCountry(question) {
...
function answer(question) {
    const selections = [getRandomCountry(question), getRandomCountry(question), getRandomCountry(question), question.name]
 ...
 buttonA.addEventListener('click', function() {
    console.log('Random.Name is : ' + countryName);
...
document.getElementById('next-button').addEventListener('click', handleQuestion)
